...
namespace evolution {
   ...
   class [[eosio::contract("evolutiondex")]] evolutiondex : public contract {
      public:
         ...
         [[eosio::action]] void onesideremli(name user, asset to_sell, extended_asset min_expected, string memo);
      ...
      private:
         ...
         void one_side_addliquidity(name user, extended_asset max_to_pay, string_view quantity);
